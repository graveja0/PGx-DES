...
###assign attributes
id <- 0
sink("./scripts/TEMP-initialize-patient-attributes.R")
...
sink()
source("./scripts/TEMP-initialize-patient-attributes.R")
unlink("./scripts/TEMP-initialize-patient-attributes.R")
...
sink("./scripts/TEMP-define-genotyping-attributes-functions.R")
...
paste0(" %>%\n\tmark(\"panel_test\")\n}\n") %>% cat()
sink()
source("./scripts/TEMP-define-genotyping-attributes-functions.R")
unlink("./scripts/TEMP-define-genotyping-attributes-functions.R")

####
## Secular Death
source('./scripts/event_secular_death.R')
source('./scripts/events_simple.R')


####
## Cleanup 
sink("./scripts/TEMP-cleanup-function.R")
...
sink()
source("./scripts/TEMP-cleanup-function.R")
unlink("./scripts/TEMP-cleanup-function.R")
...
sink("./scripts/TEMP-create-event-registry.R")
paste0(
  "event_registry <- list(
...
sink()
source("./scripts/TEMP-create-event-registry.R")
...
source('./scripts/event_main_loop_simple.R')
